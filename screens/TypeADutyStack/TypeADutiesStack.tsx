...
import TypeADutiesScreen, {
  TYPE_A_DUTIES_SCREEN_NAME,
} from './TypeADutiesScreen';
import RackIDScanScreen, {
  RACK_ID_SCAN_SCREEN_NAME,
} from '../SharedProcessScreens/RackIDScanScreen';
import CheckOutScreen, {CHECK_OUT_SCREEN_NAME} from './CheckOutScreen';
import RelocateConfirmScreen, {
  RELOCATE_CONFIRM_SCREEN_NAME,
} from './RelocateConfirmScreen';
import DeliverScreen, {
  DELIVER_SCREEN_NAME,
} from '../SharedProcessScreens/DeliverScreen';
import ArriveScreen, {ARRIVE_SCREEN_NAME} from './ArriveScreen';
import RouteContainer from '../../components/RouteContainer';
import CheckInConfirmScreen, {
  CHECK_IN_CONFIRM_SCREEN_NAME,
} from '../SharedProcessScreens/CheckInConfirmScreen';
import BagTagScanSreen, {
  BAG_TAG_SCAN_SCREEN_NAME,
} from '../SharedProcessScreens/BagTagScanScreen';
import StockTakeScreen, {
  STOCK_TAKE_RESULT_SCREEN_NAME,
} from './StockTakeResultScreen';

export const TYPE_A_DUTIES_STACK_SCREEN_NAME = 'TYPE_A_DUTIES_STACK';

export default function TypeADutuiesStackScreen(
