// * These These color set are generate from : 
// * https://callstack.github.io/react-native-paper/docs/guides/theming/#creating-dynamic-theme-colors
// * using #5cb8b2
export const MAT_LIGHT_THEME = {
    "colors": {
      "primary": "rgb(0, 106, 102)",
      "onPrimary": "rgb(255, 255, 255)",
      "primaryContainer": "rgb(112, 247, 239)",
  ...
  export const MAT_DARK_THEME = {
    "colors": {
      "primary": "rgb(79, 218, 211)",
      "onPrimary": "rgb(0, 55, 52)",
      "primaryContainer": "rgb(0, 80, 76)",
      "onPrimaryContainer": "rgb(112, 247, 239)",
