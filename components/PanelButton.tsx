    ...
    return (
        <MatSurface
            style={[
                styles.surface,
                props.style,
                props.mode === PANEL_BUTTON_MODE.OUTLINED ? styles.outlinedSurface : styles.containedSurface
            ]}
        ...
        >
            ...
            >
                <Text style={[
                    styles.text,
                    props.mode === PANEL_BUTTON_MODE.OUTLINED ? styles.outlinedText : styles.containedText
                ]}>
                    {props.label}
                </Text>
            </MatTouchableRipple>
